...
public class SortCollection {
    ...
    void sortCollection() {
        ...
        strings.addAll(List.of("test0:historie", "test0.xml", "test1:struktur", "test2:historie", "test3.xml",
                "test3:struktur"));

        Collections.sort(strings, new StringComparator());

        assertThat(strings).containsExactly("test0.xml", "test3.xml", "test1:struktur", "test3:struktur",
                "test0:historie", "test2:historie");
    }
    ...
    private static class StringComparator implements Comparator<String> {
        ...
        public int compare(String o1, String o2) {
            ...
            if (!o1.endsWith(":historie") && !o1.endsWith(":struktur")
                    && (o2.endsWith(":historie") || o2.endsWith(":struktur"))) {
                return -1;
            }

            if ((o1.endsWith(":historie") || o1.endsWith(":struktur")) && !o2.endsWith(":historie")
                    && !o2.endsWith(":struktur")) {
                return 1;
            }
