...
public class ReduceVersusCollectExamples {
    ...
    public void joiningSomeStrings() {
        List<String> integers = integers(1000);
 
        long runtimeWithReduce = runtime(
                integers.parallelStream(), ReduceVersusCollectExamples::joinWithReduce);
        System.out.println("Runtime reduce seconds: " + runtimeWithReduce);
 
        long runtimeWithCollect = runtime(
                integers.parallelStream(), ReduceVersusCollectExamples::joinWithCollect);
    ...
    private long runtime(
            ...
            Function<Stream<String>, String> streamFunction) {
